...
// Verifies that the userId in params/body matches the JWT user
...
router.get('/version', (req, res) => {
  res.json({ version: '2.4.0-postgresql', timestamp: '2026-02-11T21:30:00Z', features: ['shopify', 'meta', 'meta-oauth', 'google-ads', 'google-ads-oauth', 'whatsapp', 'google-oauth-email', 'postgresql'], storageMode: storage.usePg() ? 'postgresql' : 'json' });
});
