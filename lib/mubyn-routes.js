...
router.get('/csa/email/oauth/google/url', authenticateToken, (req, res) => {
  try {
...
router.post('/integrations/meta/oauth/complete', async (req, res) => {
  try {
    ...
    try { await fs.unlink(oauthResultFile); } catch {}
...
router.get('/version', (req, res) => {
  res.json({ version: '2.3.0-ads-oauth', timestamp: '2026-02-11T21:30:00Z', features: ['shopify', 'meta', 'meta-oauth', 'google-ads', 'google-ads-oauth', 'whatsapp', 'google-oauth-email'] });
});
