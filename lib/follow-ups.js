...
// Metrics: Integrated with MetricsTracker for monitoring
// ============================================================================
...
class FollowUpExecutor {
   ...
   */
  constructor(emailSender, database, options = {}) {
  ...
  async processDueFollowUps() {
    ...
    for (const followUp of dueFollowUps) {
      try {
        ...
        this.metrics.track(METRIC_TYPES.FOLLOW_UP_SENT, {
        ...
        this.metrics.trackApiError({
          service: 'follow-ups',
          endpoint: 'send',
          code: error.code || 'FOLLOW_UP_FAILED',
