...
<body>
  ...
  <div class="footer">
    <p class="unsubscribe">Don't want these emails? <a href="${baseUrl}/unsubscribe?email=${encodeURIComponent(to)}&token=${require('crypto').createHmac('sha256', process.env.UNSUBSCRIBE_SECRET || 'change-this-secret').update(to).digest('hex').slice(0, 32)}">Unsubscribe</a></p>
